...
public class shipping extends EntityModel<Entity> {
	...
	public shipping(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		partdefinition.addOrReplaceChild("top", CubeListBuilder.create().texOffs(0, 26).addBox(-7.0F, -2.0F, -14.0F, 14.0F, 2.0F, 14.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 12.0F, 7.0F));
		partdefinition.addOrReplaceChild("bb_main", CubeListBuilder.create().texOffs(0, 0).addBox(-7.0F, -12.0F, -7.0F, 14.0F, 12.0F, 14.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 0.0F));
